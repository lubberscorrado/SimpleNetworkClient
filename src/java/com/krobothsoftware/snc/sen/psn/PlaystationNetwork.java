 ...
 * <p/>
 * <ul>
 * <li>Token - Data retrieved by login HttpToken: Friends, Games, and Trophies.</li>
...
public class PlaystationNetwork extends SonyEntertainmentNetwork {
    ...
    /**
     * Current PS3 firmware version as of 6/27/13. Is not final since firmwares
     * change. <i>Official</i> methods need a PS3 firmware version.
     *
     * @since SEN-PSN 1.0
     */
    public static String PS3_FIRMWARE_VERSION = "4.46";
    ...
    public boolean isServiceOnline() throws IOException {
        ...
        try {
            response = new HttpRequest(GET, new URL(
                    "http://uk.playstation.com/sign-in/"))
                    .followRedirects(true).execute(httpHelper);
     ...
     * @throws IOException                 Signals that an I/O exception has occurred.
     * @throws TokenException              if token has expired or invalid
     * @throws ClientException             if parser encountered an error
     * @throws PlaystationNetworkException if psn is not available
     * @since SEN-PSN 1.0
     */
     ...
     *
     * @param token       psn login token
     * @param friendPsnId friend psn id
     * @return list of friend's game list or empty if friend has none
     * @throws IOException                 Signals that an I/O exception has occurred.
     * @throws TokenException              if token has expired or invalid
     * @throws ClientException             if parser encountered an error
     * @throws PlaystationNetworkException if friend psnId is invalid or psn is not available
     * @since SEN-PSN 1.0
     */
     ...
     * @param token       psn login token
     * @param friendPsnId friend psn id
     * @param titleLinkId UK title link id
     * @return list of friend's trophy list
     * @throws IOException                 Signals that an I/O exception has occurred.
     * @throws TokenException              if token has expired or invalid
     * @throws ClientException             if parser encountered an error
     * @throws PlaystationNetworkException if friend psnId or trophy link Id is invalid, or psn is not
     *                                     available
     * @since SEN-PSN 1.0
     */
     ...
     * @throws IOException                 Signals that an I/O exception has occurred.
     * @throws TokenException              if token has expired or invalid
     * @throws PlaystationNetworkException if trophy link id is invalid or psn is not available
     */
    ...
    private HttpResponse getTokenResponse(String url, String referer,
        ...
        if (response instanceof HttpResponseRedirect) {
    ...
    public List<PsnGame> getPublicGameList(String psnId) throws IOException,
        ...
        try {
            response = new HttpRequest(
                    ...
                    .header("X-Requested-With", "XMLHttpRequest")
                    .put(cookieList).execute(httpHelper);
     ...
     *
     * @param psnId       psn id
     * @param titleLinkId US trophy link id
     * @param gameId      Optional <i>Official</i> game Id. </b>Will not affect
     *                    request.</b>
     * @return list of trophies or empty list if user has none. Will return an
     *         empty list if title link Id is invalid.
     * @throws IOException     Signals that an I/O exception has occurred.
     * @throws ClientException if parser encountered an error or US login cookies invalid
     * @since SEN-PSN 1.0
     */
    ...
    public String getOfficialJid(String psnId) throws IOException {
        ...
        try {
            ...
            response = new HttpRequestAuthenticate(
                    POST,
                    new URL(
                            "http://searchjid.usa.np.community.playstation.net/basic_view/func/search_jid"))
     ...
     * </p>
     *
     * @param platform platform to check firmware
     * @return firmware version of platform
     * @throws IOException              Signals that an I/O exception has occurred.
     * @throws IllegalArgumentException if platform is invalid, UNKNOWN
     * @since SEN-PSN 1.0
     */
     ...
     *
     * @param jid       jid
     * @param start     start index. Must be one or greater.
     * @param max       max games
     * @param platforms platforms for games
     * @return official game list, empty if account has none
     * @throws IllegalArgumentException    thrown if start index is zero or less
     * @throws IOException                 Signals that an I/O exception has occurred.
     * @throws ClientException             if parser encountered an error or US login cookies invalid
     * @throws PlaystationNetworkException if jid is invalid
     * @since SEN-PSN 1.0
     */
     ...
     *
     * @param jid    jid
     * @param gameId <i>Official</i> game id
     * @return official trophy list or empty if none found for gameId
     * @throws IllegalArgumentException    thrown if game id isn't in <i>Official</i> format
     * @throws IOException                 Signals that an I/O exception has occurred.
     * @throws ClientException             if parser encountered an error or US login cookies invalid
     * @throws PlaystationNetworkException if jid is invalid
     * @since SEN-PSN 1.0
     ...
     *
     * @param jid       jid
     * @param max       max amount of trophies
     * @param platforms platforms for trophies
     ...
     * @param jid       jid
     * @param max       max amount of trophies
     * @param since     date in format <code>yyyy-MM-dd'T'HH:mm:ss.SSSZ</code>
     * @param platforms platforms for trophies
